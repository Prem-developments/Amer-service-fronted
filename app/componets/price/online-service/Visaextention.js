...
const Visaextention = () => {
    const additionalDivs = [
        { id: 1, title: 'Visit Visa Extend', inside: '995.90 AED' },
        { id: 2, title: 'Gulf Residents Visit Visa Extend', inside: '995.90 AED' },
        { id: 3, title: 'On Arrival Visa Extension', inside: '995.90 AED' },
      ];
