...
const Cancellation = () => {
    const additionalDivs = [
        { id: 1, title: 'Family Residence Visa Cancellation', inside: '288.90 AED', outside: '388.90 AED' },
        { id: 2, title: 'Employment Visa Cancellation', inside: '325.00 AED', outside: '425.00 AED' },
        { id: 3, title: 'Partner / Investor Visa Cancellation', inside: '325.00 AED', outside: '425.00 AED' },
        { id: 4, title: 'Virtual Work Visa Cancellation', inside: '325.00 AED', outside: '425.00 AED' },
        { id: 5, title: 'Cancellation - Entry Permit (After Entry) – Company', inside: '325.00 AED' },
        { id: 6, title: 'Cancellation - Entry Permit (After Entry) – Company', inside: '325.00 AED' },
      ];
