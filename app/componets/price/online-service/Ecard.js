...
const Ecard = () => {
    const additionalDivs = [
        { id: 1, title: 'New Establishment Card with Online', inside: '2880.90 AED' },
        { id: 2, title: 'New Establishment Card without Online', inside: '576.90 AED' },
        { id: 3, title: 'Renewal of - Establishment Card with Online', inside: '1825.90 AED' },
        { id: 4, title: 'Renewal of - Establishment Card with Online', inside: '676.90 AED' },
      ];
