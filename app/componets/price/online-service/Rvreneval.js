...
const Rvreneval = () => {
    const additionalDivs = [
        { id: 1, title: 'Spouse & Children Visa Renewal', inside: '609.90 AED' },
        { id: 2, title: 'Parents Visa Renewal (01 Year)', inside: '509.90 AED' },
        { id: 3, title: 'Employment Visa Renewal', inside: '646.90 AED' },
        { id: 4, title: 'Partner/Investor Visa Renewal', inside: '646.90 AED' },
      ];
